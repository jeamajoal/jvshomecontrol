...
// Tertiary text size (info card values).
// 100 = default, 50 = half-size, 200 = double-size.
const UI_TERTIARY_TEXT_SIZE_PCT_DEFAULT = 100;
const UI_TERTIARY_TEXT_SIZE_PCT_MIN = 50;
const UI_TERTIARY_TEXT_SIZE_PCT_MAX = 200;
...
const UI_PRIMARY_TEXT_OPACITY_PCT_MIN = 0;
const UI_PRIMARY_TEXT_OPACITY_PCT_MAX = 100;

// Secondary text opacity (0-100%).
const UI_SECONDARY_TEXT_OPACITY_PCT_DEFAULT = 45;
const UI_SECONDARY_TEXT_OPACITY_PCT_MIN = 0;
const UI_SECONDARY_TEXT_OPACITY_PCT_MAX = 100;

// Tertiary text opacity (0-100%) - used for info card values.
const UI_TERTIARY_TEXT_OPACITY_PCT_DEFAULT = 70;
const UI_TERTIARY_TEXT_OPACITY_PCT_MIN = 0;
const UI_TERTIARY_TEXT_OPACITY_PCT_MAX = 100;
...
const UI_TERTIARY_TEXT_SIZE_PCT_RANGE = Object.freeze({
    min: UI_TERTIARY_TEXT_SIZE_PCT_MIN,
    max: UI_TERTIARY_TEXT_SIZE_PCT_MAX,
    def: UI_TERTIARY_TEXT_SIZE_PCT_DEFAULT,
});
...
const UI_PRIMARY_TEXT_OPACITY_PCT_RANGE = Object.freeze({
    min: UI_PRIMARY_TEXT_OPACITY_PCT_MIN,
    max: UI_PRIMARY_TEXT_OPACITY_PCT_MAX,
    def: UI_PRIMARY_TEXT_OPACITY_PCT_DEFAULT,
});

const UI_SECONDARY_TEXT_OPACITY_PCT_RANGE = Object.freeze({
    min: UI_SECONDARY_TEXT_OPACITY_PCT_MIN,
    max: UI_SECONDARY_TEXT_OPACITY_PCT_MAX,
    def: UI_SECONDARY_TEXT_OPACITY_PCT_DEFAULT,
});

const UI_TERTIARY_TEXT_OPACITY_PCT_RANGE = Object.freeze({
    min: UI_TERTIARY_TEXT_OPACITY_PCT_MIN,
    max: UI_TERTIARY_TEXT_OPACITY_PCT_MAX,
    def: UI_TERTIARY_TEXT_OPACITY_PCT_DEFAULT,
});

const UI_ICON_OPACITY_PCT_RANGE = Object.freeze({
    min: UI_ICON_OPACITY_PCT_MIN,
    max: UI_ICON_OPACITY_PCT_MAX,
...
module.exports = {
    ...
    UI_TERTIARY_TEXT_SIZE_PCT_DEFAULT,
    UI_TERTIARY_TEXT_SIZE_PCT_MIN,
    UI_TERTIARY_TEXT_SIZE_PCT_MAX,
    ...
    UI_PRIMARY_TEXT_OPACITY_PCT_MIN,
    UI_PRIMARY_TEXT_OPACITY_PCT_MAX,
    UI_SECONDARY_TEXT_OPACITY_PCT_DEFAULT,
    UI_SECONDARY_TEXT_OPACITY_PCT_MIN,
    UI_SECONDARY_TEXT_OPACITY_PCT_MAX,
    UI_TERTIARY_TEXT_OPACITY_PCT_DEFAULT,
    UI_TERTIARY_TEXT_OPACITY_PCT_MIN,
    UI_TERTIARY_TEXT_OPACITY_PCT_MAX,
    ...
    UI_PRIMARY_TEXT_OPACITY_PCT_RANGE,
